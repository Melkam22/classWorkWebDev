...
var myHumidity = document.querySelector(".one");
var myWind = document.querySelector(".two");
...
myInput.addEventListener("click", function () {
  var myValue = document.querySelector(".input");
  var myCity = myValue.value;
  var myFullApi = "http://api.openweathermap.org/data/2.5/weather?q=".concat(myCity, "&APPID=950a99d07777436d293fd763f07f0f90&units=metric");
  fetch(myFullApi).then(function (response) {
